...
def generate_plot(correct_rows, false_rows):
    ...
    try:
        ...
        fig.suptitle('Permutation Approach (block size = 10)')
        ...
        plot_path = "./permute_similarity_dist10.png"
...
generation = np.load("./bowblock10/tmp/sample/generations/0.npy")
losses = np.load("./bowblock10/tmp/sample/losses/0.npy")
