...
def generate_full_curve(rows, num_samples):
    ...
    try:
        ...
        #plt.semilogx()
        plt.title('Permutation b=1')
        plt.xlabel("Number of bad guesses")
        plt.ylabel("Recall")
        
        plot_path = "./error_curve_permute5_1.png"
...
parser.add_argument("--submission", default="./guess5_permute1.csv") #was example_submission.csv
parser.add_argument("--answer", default="../../datasets/train_suffix.npy") #was fake_test_suffixes.npy
parser.add_argument("--num_samples", default=1000) #was 1000 for validation
