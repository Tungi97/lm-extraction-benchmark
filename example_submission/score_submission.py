...
def generate_full_curve(rows, num_samples):
    ...
    try:
        ...
        #plt.semilogx()
        plt.title('Permutation Similarity (block size 10)')
        plt.xlabel("Number of bad guesses")
        plt.ylabel("Recall")
        
        plot_path = "./permutation_bow_10_1_error_curve_train.png"
...
parser.add_argument("--submission", default="../approach_permutation/bowblock10/guess1.csv") #was example_submission.csv
parser.add_argument("--answer", default="../datasets/train_suffix.npy") #was fake_test_suffixes.npy
parser.add_argument("--num_samples", default=14000) #was 1000 for validation

args = parser.parse_args()

answers = np.load(args.answer)[:-1000] # for validation take [-1000:]
